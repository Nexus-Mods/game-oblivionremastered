...
export const NOTIF_ID_REQUIREMENTS = `${GAME_ID}-requirements-download-notification`;
export const NOTIF_ID_UE4SS_UPDATE = `${GAME_ID}-ue4ss-version-update`;
...
export const UE4SS_PATH_PREFIX = path.join(MAIN_UE_PATH, 'Binaries');
